...
--changeset SoslanGassiev:create-identity-schema
--comment create new identity schema

create schema identity
--rollback drop schema identity;

--changeset SoslanGassiev:create-identity-user_accounts-table
...
--changeset SoslanGassiev:create-identity-user_roles-table
...
--changeset SoslanGassiev:create-identity-user_accounts_roles-table
--comment create table identity.user_roles
...
--changeset SoslanGassiev:add-user_accounts_roles-table-constraints
...
--changeset SoslanGassiev:add-data-to-user_roles-table
